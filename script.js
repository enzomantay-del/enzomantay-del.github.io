...
const translations = {
  en: {
    ...
    stat3:        "Public Sites Live",
    stat4:        "University Degrees",
    projects_tag:   "Work",
    projects_title: "Featured Projects",
    badge_live:   "Live Project",
    proj1_desc:   "Municipal tourism management system in production (restricted access). Visitor registration, events, hotel occupancy analytics, WhatsApp integration and automated monthly reports.",
    proj2_desc:   "Municipal campaign platform in production (restricted access): neighborhood contacts, public form for community leaders, mass WhatsApp sends and delivery/read metrics panel.",
    proj3_desc:   "Public tour catalog for a travel agency — browse packages and inquire via WhatsApp. Full Django management system behind the scenes.",
    proj4_desc:   "Official municipal portal in production: news by department, interactive public works maps, citizen reports, admin panels, push notifications and internal staff agenda.",
    proj5_desc:   "Full commercial event platform: merchant registration, offer approval workflow, public deals site, tourism circuit sign-ups and admin panel.",
    proj6_desc:   "Full e-commerce stack: product catalog, shopping cart, checkout, admin panel, inventory, image gallery and order management.",
  ...
  es: {
    ...
    stat3:        "Sitios Públicos en Vivo",
    stat4:        "Títulos Universitarios",
    projects_tag:   "Trabajos",
    projects_title: "Proyectos Destacados",
    badge_live:   "En Producción",
    proj1_desc:   "Sistema de gestión turística municipal en producción (acceso restringido). Registro de visitantes, eventos, ocupación hotelera, WhatsApp e informes mensuales automatizados.",
    proj2_desc:   "Plataforma municipal de campaña en producción (acceso restringido): contactos por barrio, formulario para referentes, envíos masivos WhatsApp y panel de métricas.",
    proj3_desc:   "Catálogo web público de agencia de viajes — paquetes turísticos y consultas por WhatsApp. Sistema de gestión completo con Django detrás.",
    proj4_desc:   "Portal municipal oficial en producción: novedades por área, mapas interactivos de obras, reportes ciudadanos, paneles admin, notificaciones push y agenda interna.",
    proj5_desc:   "Plataforma completa del evento comercial: registro de comerciantes, flujo de aprobación de ofertas, sitio público, circuitos turísticos y panel admin.",
    proj6_desc:   "E-commerce full stack: catálogo, carrito, checkout, panel admin, inventario, galería de imágenes y gestión de pedidos.",
